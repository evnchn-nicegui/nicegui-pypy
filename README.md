...
| `pypy3.10` · main | `main` (`a9121acf0858`) | ❌ (watchfiles) | — | — |
| `pypy3.11` · main | `main` (`a9121acf0858`) | ✅ | ✅ | 328✅ 1❌ · **≈ CPython ✓** |
| CPython 3.11 *(control)* · main | `main` (`a9121acf0858`) | ✅ | ✅ | 329✅ |

_Last run: 2026-08-11T06:41:59Z · Install = NiceGUI runtime · Boot = import + server + HTTP probe · Core tests = NiceGUI's own suite subset — real **Selenium/Chrome browser** element tests + `user`/unit tests (the full suite also needs pandas/matplotlib-class deps that don't run on PyPy — see README). The **CPython 3.11 control** runs the identical subset._
<!-- COMPAT:END -->
