...
| `pypy3.10` · main | `main` (`1d0405a82745`) | ❌ (watchfiles) | — | — |
| `pypy3.11` · main | `main` (`1d0405a82745`) | ✅ | ✅ | 328✅ 1❌ · **≈ CPython ✓** |
| CPython 3.11 *(control)* · main | `main` (`1d0405a82745`) | ✅ | ✅ | 329✅ |

_Last run: 2026-08-07T06:56:09Z · Install = NiceGUI runtime · Boot = import + server + HTTP probe · Core tests = NiceGUI's own suite subset — real **Selenium/Chrome browser** element tests + `user`/unit tests (the full suite also needs pandas/matplotlib-class deps that don't run on PyPy — see README). The **CPython 3.11 control** runs the identical subset._
<!-- COMPAT:END -->
