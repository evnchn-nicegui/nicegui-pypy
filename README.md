...
| `pypy3.10` · main | `main` (`c4016da92794`) | ❌ (pydantic-core) | — | — |
| `pypy3.11` · main | `main` (`c4016da92794`) | ✅ | ✅ | 329✅ · **≈ CPython ✓** |
| CPython 3.11 *(control)* · main | `main` (`c4016da92794`) | ✅ | ✅ | 329✅ |

_Last run: 2026-07-31T08:26:56Z · Install = NiceGUI runtime · Boot = import + server + HTTP probe · Core tests = NiceGUI's own suite subset — real **Selenium/Chrome browser** element tests + `user`/unit tests (the full suite also needs pandas/matplotlib-class deps that don't run on PyPy — see README). The **CPython 3.11 control** runs the identical subset._
<!-- COMPAT:END -->
