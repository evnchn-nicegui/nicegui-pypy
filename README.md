...
| `pypy3.10` · main | `main` (`b6b330bf5855`) | ❌ (watchfiles) | — | — |
| `pypy3.11` · main | `main` (`b6b330bf5855`) | ✅ | ✅ | 350✅ · **≈ CPython ✓** |
| CPython 3.11 *(control)* · main | `main` (`b6b330bf5855`) | ✅ | ✅ | 350✅ |

_Last run: 2026-09-14T11:02:36Z · Install = NiceGUI runtime · Boot = import + server + HTTP probe · Core tests = NiceGUI's own suite subset — real **Selenium/Chrome browser** element tests + `user`/unit tests (the full suite also needs pandas/matplotlib-class deps that don't run on PyPy — see README). The **CPython 3.11 control** runs the identical subset._
<!-- COMPAT:END -->
