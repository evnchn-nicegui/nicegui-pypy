...
|--------|---------|---------|------|------------|
| `pypy3.10` · pypi | `3.16.0` | ❌ (pydantic-core) | — | — |
| `pypy3.11` · pypi | `3.16.0` | ✅ | ✅ | 341✅ 1❌ · **≈ CPython ✓** |
| CPython 3.11 *(control)* · pypi | `3.16.0` | ✅ | ✅ | 342✅ |
| `pypy3.10` · main | `main` (`4cdf8edd845a`) | ❌ (watchfiles) | — | — |
| `pypy3.11` · main | `main` (`4cdf8edd845a`) | ✅ | ✅ | 341✅ 1❌ · **≈ CPython ✓** |
| CPython 3.11 *(control)* · main | `main` (`4cdf8edd845a`) | ✅ | ✅ | 342✅ |

_Last run: 2026-08-23T06:18:42Z · Install = NiceGUI runtime · Boot = import + server + HTTP probe · Core tests = NiceGUI's own suite subset — real **Selenium/Chrome browser** element tests + `user`/unit tests (the full suite also needs pandas/matplotlib-class deps that don't run on PyPy — see README). The **CPython 3.11 control** runs the identical subset._
<!-- COMPAT:END -->
